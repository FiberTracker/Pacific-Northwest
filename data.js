...
const CONSOLIDATION_CANDIDATES = [
    ...
    { provider: "SkyNet Communications LLC", providerId: "330070", states: ["MT"], totalBSLs: 39091, fiberBSLs: 27363, keyMarkets: "Bozeman, MT", techMix: "Fiber", ownership: "Chris Johnson (founder-owned)", estPassings: 46909, strategicNotes: "Bozeman local fiber ISP. Founder-owned. Fast-growing market." },
    ...
    { provider: "Konceptio Data Services, LLC", providerId: "230025", states: ["MT"], totalBSLs: 29065, fiberBSLs: 20345, keyMarkets: "Montana", techMix: "Fiber", ownership: "Private LLC", estPassings: 34878, strategicNotes: "Montana data/fiber provider." },
    ...
    { provider: "Montana Opticom LLC", providerId: "240061", states: ["MT"], totalBSLs: 20452, fiberBSLs: 14316, keyMarkets: "Montana", techMix: "Fiber", ownership: "Private LLC", estPassings: 24542, strategicNotes: "Montana fiber provider. Private ownership." },
    ...
    { provider: "MontanaSky Networks, Inc.", providerId: "270063", states: ["MT"], totalBSLs: 17063, fiberBSLs: 11944, keyMarkets: "NW Montana (Kalispell area)", techMix: "Fiber", ownership: "Frederick Weber (founder-majority owner)", estPassings: 20475, strategicNotes: "NW Montana founder-owned fiber ISP. Kalispell/Flathead Valley." },
    // === IDAHO + MONTANA ===
    { provider: "Blackfoot Telephone Cooperative, Inc.", providerId: "130132", states: ["ID", "MT"], totalBSLs: 47774, fiberBSLs: 33441, keyMarkets: "Missoula, MT / SE Idaho", techMix: "Fiber", ownership: "Member-owned coop since 1954 (acquired Cutthroat 2012, Modwest; HQ Missoula)", estPassings: 57328, strategicNotes: "Largest ID/MT coop. Missoula-based since 1954. Active acquirer (Cutthroat, Modwest). Strong FTTP footprint." },
    // === OREGON ===
    ...
    { provider: "Webformix Company", providerId: "290118", states: ["OR"], totalBSLs: 36947, fiberBSLs: 25862, keyMarkets: "Bend, OR (HQ)", techMix: "Fiber", ownership: "Eric Ozrelic (founder)", estPassings: 44336, strategicNotes: "Bend-based wireless ISP expanding to fiber. Founder-owned." },
    ...
    { provider: "LICT Corporation", providerId: "160127", states: ["OR"], totalBSLs: 20578, fiberBSLs: 14404, keyMarkets: "Southern Oregon (Cal-Ore subsidiary)", techMix: "Fiber", ownership: "Publicly traded (OTC Pink: LICT); Mario Gabelli/GAMCO ~24% ownership", estPassings: 24693, strategicNotes: "ONLY publicly traded entity. Cal-Ore subsidiary in OR. GAMCO/Gabelli ~24%. Small-cap holding company." },
